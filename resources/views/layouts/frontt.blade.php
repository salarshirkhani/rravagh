...
<head>
  ...
  <link rel="manifest" href="/manifest.json">
  <meta name="enamad" content="510502" />
            ...
            <ul>
              <li class="hassubmenu"><a href="">
                <svg width="29" height="28" viewBox="0 0 29 28" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.625 19.8333H11C11.4644 19.8333 11.6966 19.8333 11.8916 19.859C13.2378 20.0362 14.2971 21.0955 14.4743 22.4417C14.5 22.6367 14.5 22.8689 14.5 23.3333V10.6667C14.5 7.83823 14.5 6.42402 13.6213 5.54534C12.7426 4.66666 11.3284 4.66666 8.5 4.66666H5.625C4.68219 4.66666 4.21079 4.66666 3.91789 4.95955C3.625 5.25244 3.625 5.72385 3.625 6.66666V17.8333C3.625 18.7761 3.625 19.2475 3.91789 19.5404C4.21079 19.8333 4.68219 19.8333 5.625 19.8333Z" fill="#7E869E" fill-opacity="0.25" stroke="#2892A8" stroke-width="1.2"/><path d="M23.375 19.8334H18C17.5356 19.8334 17.3034 19.8334 17.1084 19.859C15.7622 20.0362 14.7029 21.0956 14.5257 22.4418C14.5 22.6367 14.5 22.8689 14.5 23.3334V10.6667C14.5 7.83826 14.5 6.42405 15.3787 5.54537C16.2574 4.66669 17.6716 4.66669 20.5 4.66669H23.375C24.3178 4.66669 24.7892 4.66669 25.0821 4.95958C25.375 5.25247 25.375 5.72388 25.375 6.66669V17.8334C25.375 18.7762 25.375 19.2476 25.0821 19.5405C24.7892 19.8334 24.3178 19.8334 23.375 19.8334Z" fill="#7E869E" fill-opacity="0.25" stroke="#2892A8" stroke-width="1.2"/></svg>دسته‌بندی کتاب‌ها</a>
                 <ul class="submenu">
					@foreach($categories->whereNull('parent_id')->where('type','product') as $category)
						<li>
              ...
              <li><a href="{{route('media.index')}}">آموزش</a></li>
              <li><a href="{{route('discountable')}}">حمایت از کتاب</a></li>
              <li><a href="{{route('media.videos')}}">ویدیوها</a></li>
...
.overlay-menu {
  ...
  background: rgba(0, 0, 0, 0.7); /* تیره اما شفاف */
  ...
  <footer class="phonefooter">
    <div class="container">
      <div class="row">
        <div class="col">
          <li class="homebtn">
            <a href="{{route('/')}}"><svg width="52" height="48" viewBox="0 0 52 48" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <span class="icon-label">خانه</span> 
            </a>
          </li>
        </div>
        <div class="col">
          <li class="profbtn">
            <a href="{{route('dashboard.customer.index')}}">
              ...
              <span class="icon-label">پنل </span> 
            </a>
          </li>
        </div>
        <div class="col">
          <li class="sabadbtn">
            <a href="{{route('cart')}}">
              ...
              <span class="icon-label">سبد </span> 
            </a>
          </li>
        </div>
        <div class="col">
          <li class="bookbtn">
           <a href="{{route('discountable')}}">
            ...
            <span class="icon-label">مقالات</span> 
            </a>
          </li>
        </div>
        <div class="col">
          <li class="menubtn">
            <a href="#">
            <button id="toggleMenuBtn" class="menu-trigger" style="background: none;border: none;">
              ...
              <span class="icon-label" style="margin-top:5px;">فهرست</span> 
            </button> 
            </a>
          </li>
            <div id="overlayMenu" class="overlay-menu">
              ...
              <ul class="overlay-menu-items">
                <li class="has-submenum">
                    <button id="toggleSubmenu" class="submenum-trigger">دسته بندی کتاب ها ▾</button>
                    <ul id="submenu" class="submenum">
                    	@foreach($categories->whereNull('parent_id')->where('type','product') as $category)
    						<li>
    						    <a href="{{route('category',['slug'=>$category->slug])}}">{{ $category->name }}</a>
    						</li>
      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="aboutft">
            <h3>درباره‌ی رواق</h3>
            <p>
                رواق جایی است برای توسعه‌ی محتوای مذهبی و اخلاقی. چه از طریق صنعت چاپ و چه از راه دنیای دیجیتال.
            </p>
            <span style=" margin-left: 30px;  margin-top: 10px; color: #121864; ">
                شماره تماس : 09122706145
            </span>
            <span style=" margin-top: 10px; color: #121864; "> 
                شماره تماس ثابت : 02166090135
            </span> <br>
            <span style="margin-left: 30px; margin-top: 10px; color: #121864; "> 
                 ایمیل : info@rravagh.com
            </span>
            <span style="margin-top: 10px; ">
                ساعات پاسخگویی : از 9 تا 16            
            </span>
        ...
        <div class="col-md-2">
          <div class="footother">
            ...
            <a referrerpolicy='origin' target='_blank' href='https://trustseal.enamad.ir/?id=486781&Code=7P3wH6swhKtwdA93oGlOYR6oFXpw7MTN'><img referrerpolicy='origin' src='https://trustseal.enamad.ir/logo.aspx?id=486781&Code=7P3wH6swhKtwdA93oGlOYR6oFXpw7MTN' alt='' style='cursor:pointer' Code='7P3wH6swhKtwdA93oGlOYR6oFXpw7MTN'></a>
          </div>
        </div>
      </div>
    </div>
