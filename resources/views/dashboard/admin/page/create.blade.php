...
@section('hierarchy')
    ...
    <x-breadcrumb-item title="افزودن لندینگ" route="dashboard.admin.page.create" />
@endsection
@section('content')
@if(Session::has('info'))
    <div class="row">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.4.0/dropzone.js"></script>
    <div class="col-md-12">
        <x-card type="info">
            <x-card-header>لندینگ پیچ</x-card-header>
        <form style="padding:10px;" action="{{ route('dashboard.admin.page.create') }}" method="post" role="form" class="form-horizontal " enctype="multipart/form-data">
