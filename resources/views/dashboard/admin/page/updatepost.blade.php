...
@section('hierarchy')
    ...
    <x-breadcrumb-item title="ویرایش لندینگ" route="dashboard.admin.page.updatepage" />
@endsection
@section('content')
    @if(Session::has('info'))
    <div class="row">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.4.0/dropzone.js"></script>
    <div class="col-md-12">
        ...
        <form action="{{ route('dashboard.admin.page.updatepage', $post->id) }}" method="post" role="form" class="form-horizontal " enctype="multipart/form-data" style="padding:10px;">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                          <button type="button" class="btn btn-outline-light uncheckd" data-dismiss="modal">خیر</button>
                                           <form  action="#" method="post">
                                              ...
                                              <a href="{{route('dashboard.admin.page.pdeletetags',['ids'=>$item->id])}}" class="btn btn-outline-light">بله </a>
                                           </form>
                                        </div>
                                      </div>
                                      <!-- /.modal-content -->
