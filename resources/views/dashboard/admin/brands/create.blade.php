...
@section('hierarchy')
    ...
    <x-breadcrumb-item title="افزودن برند" route="dashboard.admin.brands.create" />
@endsection
@section('content')
@if(Session::has('info'))
    <div class="row">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/dropzone/5.4.0/dropzone.js"></script>
    <div class="col-md-12">
        <x-card type="info">
            <x-card-header>افزودن برند جدید</x-card-header>
        <form style="padding:10px;" action="{{ route('dashboard.admin.brands.create') }}" method="post" role="form" class="form-horizontal " enctype="multipart/form-data">
            ...
            <input type="text" style="padding:10px; margin: 10px 0px 16px 0px; height: 40px; border-radius: 7px; font-size: 16px;"class="form-control" required name="url"  placeholder="لینک ">
